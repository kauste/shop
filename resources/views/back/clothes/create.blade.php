                ...
                <form method="post" action="{{route('cloth-store')}}">
                    <div class="form-row align-items-center d-flex">
                        <div class="col-md-7">
                            ...
                            <input required type="text" class="form-control" name="cloth_name">
                        </div>
                        <div class="col-md-5">
                    ...
                    <div class="form-row align-items-center d-flex">
                        <div class="col-md-3">
                            ...
                            <input required type="text" class="form-control" name="amount_left">
                        </div>
                        <div class="col-md-3">
                            <label for="price">Price</label>
                            <div class="d-flex align-items-center ml-1">
                                <input required amount="price" type="number" id="price" class="form-control" name="price"><span>eu.</span>
                            </div>
                        </div>
                        <div class="col-md-3">
